...
class CircleImageWidget extends StatelessWidget {
  ...
  bool get _hasValidNetworkImage {
    ...
    return value.isNotEmpty &&
        ...
        !value.endsWith('/') &&
        !value.toLowerCase().endsWith('/null');
  }

  @override
  Widget build(BuildContext context) {
    Widget fallbackImage(double fallbackWidth, double fallbackHeight) {
      return Image.asset(
              ...
              child: Container(
                ...
                child: CachedNetworkImage(
                    ...
                    errorWidget: (ctx, object, trx) {
                      return fallbackImage(height, width);
                    },
                    placeholder: (ctx, trx) {
                      return fallbackImage(height, width);
                    }),
